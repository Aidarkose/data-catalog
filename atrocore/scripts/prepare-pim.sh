#!/bin/bash
# Адаптация официального prepare-pim.sh из gitlab.atrocore.com/atrocore/docker.
# Без изменений по сути — только формат и комментарии под OMEGA-3.
...
echo "AtroCore instance for $3 is ready to install."
